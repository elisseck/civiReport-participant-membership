 ...
 *
 */
class CRM_Report_Form_Event_ParticipantMemberships extends CRM_Report_Form_Event {
...
//E.L. Add Membership columns and filters to event report
      'civicrm_membership' => array(
        ...
        'fields' => array(
          'membership_type_id' => array(
            ...
            //'required' => TRUE, <<not sure about this change so i'll comment it out. I don't think we want to require this
          ),
		  'status_id' => array(
    ...
    foreach ($rows as $rowNum => $row) {
	  ...
	  if (array_key_exists('civicrm_membership_status_id', $row)) {
        if ($value = $row['civicrm_membership_status_id']) {
          $rows[$rowNum]['civicrm_membership_status_id'] = CRM_Member_PseudoConstant::membershipStatus($value, FALSE);
        }
        $entryFound = TRUE;
      }
